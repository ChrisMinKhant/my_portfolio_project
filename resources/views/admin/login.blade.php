        ...
        <div class="row">
            <div class="col-4 offset-4">
                <form class="mt-5 shadow-lg p-5 rounded-5">
                    ...
                    {{-- submit button --}}
                    <div class="row mt-3">
                        <a href="{{ route('admin#registerpage') }}" class="text-decoration-none text-dark fs-6 text-center">Don't Have An Account? <span class="text-primary">Register Here.</span></a>
                    </div>
                </form>
            </div>
        </div>
